...
def client_a(test_org1, client_manager):
    ...
    # Cleanup (managers use async delete; run from sync test)
    try:
        asyncio.run(client_manager.delete_client_by_id(created_client.id))
    except Exception:
        pass
...
class TestOrganizationScopedUserCreation:
    ...
    def test_create_user_is_organization_scoped(self, user_manager, test_org1):
        ...
        # Cleanup
        try:
            asyncio.run(user_manager.delete_user_by_id(user_id))
        except Exception:
            pass
...
class TestClientDeletionPreservesUsers:
    ...
    def test_delete_client_preserves_users(self, user_manager, client_manager, test_org1):
        ...
        try:
            ...
            # Delete the client
            asyncio.run(client_manager.delete_client_by_id(client_id))
...
class TestGetOrCreateOrgDefaultUser:
    ...
    def test_get_or_create_org_default_user_creates_user(self, user_manager, test_org1):
        ...
        # Cleanup
        try:
            asyncio.run(user_manager.delete_user_by_id(default_user.id))
        except Exception:
            pass
    ...
    def test_get_or_create_org_default_user_is_idempotent(self, user_manager, test_org1):
        ...
        # Cleanup
        try:
            asyncio.run(user_manager.delete_user_by_id(default_user_1.id))
        except Exception:
            pass
    ...
    def test_get_or_create_org_default_user_different_orgs(self, user_manager, test_org1, test_org2):
        ...
        # Cleanup
        try:
            asyncio.run(user_manager.delete_user_by_id(default_user_org1.id))
        except Exception:
            pass
        try:
            asyncio.run(user_manager.delete_user_by_id(default_user_org2.id))
        except Exception:
            pass
