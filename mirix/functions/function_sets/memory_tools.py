...
async def direct_write_episodic(
    ...
    *,
    ...
    # Resolve timestamp: prefer explicit arg, then agent.occurred_at, else now.
    ...
    # Preserve any filter_tags already hydrated on the agent (which should carry
    # scope); fall back to {"scope": client.write_scope} only if absent.
