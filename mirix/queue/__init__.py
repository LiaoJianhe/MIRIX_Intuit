...
def process_external_message(raw_message: bytes) -> None:
    ...
    This is the primary API for integrating with external Kafka consumers or event processing
    systems. It handles all internal details of deserialization and processing, providing a
    clean abstraction layer for external applications.
